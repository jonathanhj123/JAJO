  ...
  (() => {
          ...
          function r(e, r) {
            for (var i = {}, a = [], s = 0; s < e.length; s++) {
              ...
              if (-1 !== p) (n[p].references++, n[p].updater(f));
                ...
                var v = o(f, r);
                ((r.byIndex = s),
                  n.splice(s, 0, { identifier: u, updater: v, references: 1 }));
              }
              a.push(u);
            }
            return a;
    ...
    return (
      (() => {
        ...
        function N(e) {
          e.isExpanded
            ? ((e.isExpanded = !1), E(e), x(e))
            : ((e.isExpanded = !0), b(e), j(e));
        }
        function C(e, n) {
          (n(e),
            e.children.length > 0 &&
        ...
        function T(e = {}) {
          ...
          return (
            ((e) => "object" === h(e) && 0 === Object.keys(e).length)(n) &&
              (n = "{}"),
            {
              key: e.key || null,
        ...
        function w(e, n) {
          ...
          (C(e, function (e) {
            ((e.el = (function (e) {
              ...
              return (
                null !== e.parent && r.classList.add(g.HIDDEN),
        ...
        function A(e) {
          C(e, function (n) {
            ((n.isExpanded = !1),
              n.depth > e.depth && n.el.classList.add(g.HIDDEN),
              E(n));
          });
        }
        function L(e) {
